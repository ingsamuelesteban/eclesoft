    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-nav-link-parent :href="'#'" :active="request()->routeIs('padron.*')">
                    <x-slot name="name">Libros Actuales</x-slot>
                    <x-slot name="children">
                        ...
                        <span class="separator"></span>
                        <a href="#">Nombramientos</a>
                        <span class="separator"></span>
                        <a href="#">Ordenaciones</a>
                    </x-slot>
                </x-nav-link-parent>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-nav-link-parent :href="'#'" :active="request()->routeIs('padron.*')">
                    <x-slot name="name">Administración</x-slot>
                    <x-slot name="children">
                        <a href="{{route('menu.diocesis.index')}}">Diócesis</a>
                        <span class="separator"></span>
