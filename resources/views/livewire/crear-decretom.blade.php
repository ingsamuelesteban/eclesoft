<form class="md:w-full space-y-5" wire:submit.prevent='guardarDecretom'>

    <h2 class="block text-md text-gray-700 font-bold uppercase  text-center mt-2">solicitud de decreto para correcion de matrimonio</h2>
