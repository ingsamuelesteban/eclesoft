...
<form class="md:w-full space-y-5" wire:submit.prevent='crearConfirmacion'>
    ...
    <div>
        ...
        <select wire:model="sexo" id="sexo" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
            <option value="">Seleccione</option>
    ...
    <div class="grid grid-cols-2">
        ...
        <div class="grid grid-cols-2" >
            ...
            <div>
                ...
                <select wire:model="sexo_padrinos" id="sexo_padrinos" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
                    <option value="">Seleccione</option>
            ...
            <div>
                <x-text-input id="padrinos" class="block  w-full" type="text" wire:model="padrinos" :value="old('padrinos')" placeholder="Padrino o Madrina segun corresponda."/>
