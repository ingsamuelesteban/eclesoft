<div class="bg-gray-100 py-10">
    <h2 class="text-2xl md:text-4xl text-gray-600 text-center font-extrabold my-5">Buscar y Filtrar Decreto de Bautismo</h2>
            ...
            <div class="md:grid md:grid-cols-4 gap-5">
                <div class="mb-5">
                    <label 
                        ...
                        for="nombre_bautizado">Nombre del Bautizado
                    </label>
                    <input 
                        id="nombre_bautizado"
                        type="text"
                        ...
                        wire:model="nombre_bautizado"
                        autofocus
                    />
                </div>

                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold" for="fecha_solicitud">Fecha de Solicitud</label>
                    <input 
                    id="fecha_solicitud"
                    type="date"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full"
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold" for="fecha_emision">Fecha de Emisión</label>
                    <input 
                    id="fecha_emision"
                    type="date"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full"
