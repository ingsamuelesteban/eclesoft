...
<form class="md:w-full space-y-5" wire:submit.prevent='crearDiocesis'>
    ...
    <div class="grid grid-cols-3">
        ...
        <div>
            ...
            <select wire:model="titulo" id="titulo" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
                    ...
                    <option value="1">Obispo Titular</option>
                    <option value="2">Administrador Apostólico</option>
                    <option value="3">Administrador Diocesano</option>
    ...
    <div class="grid grid-cols-2">
        ...
        <div>
            ...
            <x-text-input id="vicario_general" class="block mt-1 w-full" type="text" 
        ...
        <div>
            ...
            <x-text-input id="canciller" class="block mt-1 w-full" type="text" 
