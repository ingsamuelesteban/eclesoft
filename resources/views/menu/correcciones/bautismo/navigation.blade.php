        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('menu.correccionesb.create')" :active="request()->routeIs('menu.correccionesb.create')">
                        {{ __('Crear Decreto') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('menu.correccionesb.index')" :active="request()->routeIs('menu.correccionesb.index', 'menu.correccionesb.edit',  'menu.correccionesb.show')">
                        {{ __('Buscar Decreto') }}
                    </x-nav-link>
                </div>
