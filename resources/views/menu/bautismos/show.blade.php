            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg " >
                <div class="p-10">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-4">
                                ...
                                <p class="font-bold text-sm uppercase text-gray-800 my-3">Fecha:
                                    <span class="normal-case font-normal">{{ \Carbon\Carbon::parse($bautismo->fecha_celebracion)->isoFormat('LL')}}</span>
                                </p>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-4">
                                ...
                                <p class="font-bold text-sm uppercase text-gray-800 my-3">Fecha de Nacimiento:
                                    <span class="normal-case font-normal">{{ \Carbon\Carbon::parse($bautismo->fecha_nacimiento)->isoFormat('LL')}}</span>
                                </p>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="flex flex-col md:flex-row items-stretch gap-3  mt-5 md:mt-0">
                        ...
                        <a href="#" class="bg-teal-500 py-2 px-4 rounded-lg text-white text-xs font-bold uppercase text-center ">
                            Decreto
                        </a>
                    </div>
                </div>
